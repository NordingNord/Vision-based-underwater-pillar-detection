...
//    }
    ...
    video_paths = {"../Data/Video_Data/Solo_Pillar.mkv","../Data/Video_Data/Water_Tank_2.mkv","../Data/Video_Data/Wall_Indents_Top.mkv"};
    for(int i = 0; i < relevant_settings.size();i++){
...
//                }
//                else if(i == 3){
//                    current_settings.p1 = new_setting_value*3*current_settings.block_size*current_settings.block_size;
//                }
//                else if(i == 4){
//                    current_settings.p2 = new_setting_value*3*current_settings.block_size*current_settings.block_size;
//                }
//                else if(i == 5){
